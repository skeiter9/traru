...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
     ...
     * @header apiLb.User.accessTokens
     * @object
     * @description
     *
     ...
     *
     * Call {@link apiLb.User#accessTokens User.accessTokens()}
     ...
     */
        ...
        /**
         * @ngdoc method
         * @name apiLb.User.accessTokens#createMany
         * @methodOf apiLb.User.accessTokens
         *
         * @description
         *
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name apiLb.AccessToken#createMany
         * @methodOf apiLb.AccessToken
         *
         * @description
         *
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name apiLb.Settings#createMany
         * @methodOf apiLb.Settings
         *
         * @description
         *
         ...
         * @description
         *
         * i18n translations, get translate for determined section
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `part` – `{string}` - 
         ...
         */
        "translate": {
          url: urlBase + "/settings/i18n/:part/:lang",
          method: "GET"
        },
      }
    );
...
module
  ...
  .provider('LoopBackResource', function LoopBackResourceProvider() {
    ...
    /**
     * @ngdoc method
     * @name apiLb.LoopBackResourceProvider#getUrlBase
     * @methodOf apiLb.LoopBackResourceProvider
     * @description
